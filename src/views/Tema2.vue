      ...
      .bg_img2
        .row.justify-content-center.align-items-center         
          .col-lg-10.bg-color5.px-5.pb-5       
            ...
            p(data-aos="fade-down") Puede consultar el resumen de los contenidos de cada apartado en la versión web disponible en el siguiente enlace:
            .row.justify-content-center.align-items-center.mt-5    
      ...
      .col-lg-6 
        a.anexo.mb-4.mb-lg-0.bg-a(href="https://biblioteca.sena.edu.co/paginas/bases.html" target="_blank")
          .anexo__icono
            img(src="@/assets/template/icono-link.svg")
          .anexo__texto
            p.text-white Enlace web. Debe ingresar a biblioteca SENA, ir a ICONTEC, buscar norma NTV 5667 y escoger la que desee visualizar. 
</template>
